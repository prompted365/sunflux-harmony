...
const Features = () => {
  return (
    <div className="min-h-screen bg-background dark:bg-[#1F2937] relative overflow-hidden">
      {/* Content Container */}
      <div className="relative">
        {/* Hero Section */}
        <div className="pt-24 pb-16">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl md:text-5xl font-bold text-center mb-6 text-foreground dark:text-white animate-fade-in">
              Powerful Features for Solar Success
            </h1>
            <p className="text-lg text-center text-muted-foreground dark:text-gray-300 max-w-2xl mx-auto animate-fade-in animation-delay-500">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="p-6 hover:shadow-lg transition-all duration-300 bg-card dark:bg-white/5 backdrop-blur-sm border-border dark:border-muted/20 hover:bg-accent/5 dark:hover:bg-white/10">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-2 rounded-lg bg-primary/10">
                  <Sun className="w-6 h-6 text-primary" />
                </div>
                <h3 className="text-xl font-semibold text-foreground dark:text-white">Smart Solar Analysis</h3>
              </div>
            ...
            <Card className="p-6 hover:shadow-lg transition-all duration-300 bg-card dark:bg-white/5 backdrop-blur-sm border-border dark:border-muted/20 hover:bg-accent/5 dark:hover:bg-white/10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-foreground dark:text-white">Real-time Monitoring</h3>
              </div>
              <p className="text-muted-foreground dark:text-gray-300">
            ...
            <Card className="p-6 hover:shadow-lg transition-all duration-300 bg-card dark:bg-white/5 backdrop-blur-sm border-border dark:border-muted/20 hover:bg-accent/5 dark:hover:bg-white/10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-foreground dark:text-white">Custom Reports</h3>
              </div>
              <p className="text-muted-foreground dark:text-gray-300">
            ...
            <Card className="p-6 hover:shadow-lg transition-all duration-300 bg-card dark:bg-white/5 backdrop-blur-sm border-border dark:border-muted/20 hover:bg-accent/5 dark:hover:bg-white/10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-foreground dark:text-white">Lead Management</h3>
              </div>
              <p className="text-muted-foreground dark:text-gray-300">
            ...
            <Card className="p-6 hover:shadow-lg transition-all duration-300 bg-card dark:bg-white/5 backdrop-blur-sm border-border dark:border-muted/20 hover:bg-accent/5 dark:hover:bg-white/10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-foreground dark:text-white">Performance Analytics</h3>
              </div>
              <p className="text-muted-foreground dark:text-gray-300">
            ...
            <Card className="p-6 hover:shadow-lg transition-all duration-300 bg-card dark:bg-white/5 backdrop-blur-sm border-border dark:border-muted/20 hover:bg-accent/5 dark:hover:bg-white/10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-foreground dark:text-white">Quick Integration</h3>
              </div>
              <p className="text-muted-foreground dark:text-gray-300">
      ...
      {/* Bottom Third Dusk Gradient - Positioned at the bottom */}
